...
pipeline=Pipeline([("preprocess", preprocess),("regr ", LinearRegression())]) # cat: simple_imputer, ohe, regr ; num: simple_imputer, standardscaler, regr

#2. Fit the pipeline on the training data and predict on test data
#fit train data
